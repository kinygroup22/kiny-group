...
// components/dashboard/partner-management/partner-form.tsx
"use client";
...
export function PartnerForm({ partner }: PartnerFormProps) {
  ...
  const handleFileSelect = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      formData.append('folder', 'partners'); // Upload to partners folder
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const endpoint = partner ? `/api/partners/${partner.id}` : '/api/partners';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card className="shadow-sm py-6">
        <CardHeader className="pb-4">
          ...
          <CardDescription>
            Enter the details for your partner. Required fields are marked with an asterisk (*).
          </CardDescription>
        </CardHeader>
              ...
              <div className="relative p-4 bg-muted/50 rounded-lg border">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium mb-1">{formData.name || "Partner Name"}</p>
