...
// app/dashboard/partners/new/page.tsx
  ...
  return (
    <div className="mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">Add a new partner logo to display on your about page</p>
      </div>
        ...
        <CardContent className="space-y-3">
          <div className="flex gap-3">
            ...
            <div className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
              ...
              <p>• Set the order to control how partners appear on the about page</p>
              <p>• Make sure you have the right to use the partner&apos;s logo</p>
